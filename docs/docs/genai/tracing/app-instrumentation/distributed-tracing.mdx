...
If you set up MLflow tracking to Databricks, distributed tracing requires Unity Catalog as the trace destination. Please refer to [Store MLflow traces in Unity Catalog](https://docs.databricks.com/aws/en/mlflow3/genai/tracing/trace-unity-catalog) for details.
...
mlflow.tracing.set_destination(
    UCSchemaLocation(catalog_name="my_catalog", schema_name="my_schema")
)
```
